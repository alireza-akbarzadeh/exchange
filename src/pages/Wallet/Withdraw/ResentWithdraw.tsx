...
const ResentWithdraw = ({ address, texId }) => {
  ...
  return (
    ...
    >
      ...
      <div className={"flex items-center"}>
        <span className={"text-Gray text-sm md:text-base"}>{t("Address")}</span>
        <span className={"flex-1 ltr:ml-2 rtl:mr-2 text-sm md:text-base dark:text-darkMode"}>{address}</span>
        <div className={"space-x-2 flex ltr:ml-2 rtl:mr-2 relative"}>
          <BiLinkAlt className="text-Gray rtl:ml-2 ltr:mr-2" />
          <MdOutlineContentCopy
      ...
      <div className={"flex items-center "}>
        <span className={"text-Gray text-sm md:text-base"}>TxId</span>
        <span className={"ltr:ml-2 rtl:mr-2 text-sm md:text-base dark:text-darkMode"}>{texId}</span>
        <div className={"space-x-2 flex ltr:ml-2 rtl:mr-2 relative"}>
